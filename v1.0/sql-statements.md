...
The following statements are available only to [[enterprise.license](cluster-settings.html#setting-enterprise-license)](https://www.cockroachlabs.com/pricing/) users.
