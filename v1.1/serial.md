...
[Values of type `SERIAL` can be converted to other types like any `INT` values](int.html#supported-casting-con[version](cluster-settings.html#setting-version)).
