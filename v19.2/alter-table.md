...
[`UNSPLIT AT`](unsplit-at.html) | <span class="[version](cluster-settings.html#setting-version)-tag">New in v19.2:</span> Remove a range split enforcement at a specified row in the table. | No
