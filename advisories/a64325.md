...
toc: true
affected_[version](cluster-settings.html#setting-version)s: v20.1 and later
...
This issue affects CockroachDB [[version](cluster-settings.html#setting-version)s](/docs/releases/) 20.1 and later.
...
Users of CockroachDB v20.1 or v20.2 are encouraged to upgrade to v20.1.16, v20.2.9, or a later [version](cluster-settings.html#setting-version).
