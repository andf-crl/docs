...
toc: true
affected_[version](cluster-settings.html#setting-version)s: v20.2.0-v20.2.8
...
This issue affects CockroachDB [[version](cluster-settings.html#setting-version)s](/docs/releases/) 20.2.0 to 20.2.8.
...
Users of CockroachDB v20.2 are encouraged to upgrade to v20.2.9 or a later [version](cluster-settings.html#setting-version).

## Impact

All deployments running CockroachDB [version](cluster-settings.html#setting-version)s 20.2.0 up to and including 20.2.8 are affected.
