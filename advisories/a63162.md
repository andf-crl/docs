...
toc: true
affected_[version](cluster-settings.html#setting-version)s: v19.1.0-v19.1.11, v19.2.0-v19.2.12, v20.1.0-v20.1.14, v20.2.0-v20.2.7
...
This issue affects CockroachDB [[version](cluster-settings.html#setting-version)s](/docs/releases/) 19.1 and later. It has been resolved in CockroachDB v20.1.15, v20.2.8 and the forthcoming v21.0.0. Users are advised to upgrade.

These [version](cluster-settings.html#setting-version)s are available on our [releases page](../releases/index.html).
...
Incremental backups are only available in CockroachDB's enterprise [version](cluster-settings.html#setting-version). Full backups are unaffected.
