...
toc: true
affected_[version](cluster-settings.html#setting-version)s: v20.1.4, v20.1.5
...
This regression is critical as it could silently corrupt SQL data without remediation. All unaffected customers are urged to skip releases v20.1.4 and v20.1.5 or ensure that their application code processes at most 10,000 rows per `UPSERT` statement. Customers running [version](cluster-settings.html#setting-version)s v20.1.4 or v20.1.5 are strongly encouraged to upgrade to [v20.1.6](../releases/v20.1.6.html).
