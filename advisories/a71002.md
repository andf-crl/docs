...
toc: true
affected_[version](cluster-settings.html#setting-version)s: v21.1.9
...
Only CockroachDB [version](cluster-settings.html#setting-version) 21.1.9 is affected by this bug.
...
Users of CockroachDB 21.1.9 are encouraged to upgrade to 21.1.10 or a later [version](cluster-settings.html#setting-version).
