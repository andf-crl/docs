...
[`cockroach sqlfmt`](use-the-query-formatter.html) | <span class="[version](cluster-settings.html#setting-version)-tag">New in v2.1:</span> Reformat SQL queries for enhanced clarity.
...
[`cockroach demo`](cockroach-demo.html) | <span class="[version](cluster-settings.html#setting-version)-tag">New in v2.1:</span> Start a temporary, in-memory, single-node CockroachDB cluster, and open an interactive SQL shell to it.
