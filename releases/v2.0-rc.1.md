...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.0-rc.1 since [version](cluster-settings.html#setting-version) v2.0-beta.20180326.
sitemap: false
docs_area: releases 
---
...
- Improved the **Node Map** to provide guidance when an [enterprise.license](cluster-settings.html#setting-enterprise-license) or additional configuration is required. [#24271][#24271]
