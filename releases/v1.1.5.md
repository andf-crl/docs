...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1.5 since [version](cluster-settings.html#setting-version) v1.1.4.
sitemap: false
docs_area: releases 
---
