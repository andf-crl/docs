...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1.9 since [version](cluster-settings.html#setting-version) v1.1.8
sitemap: false
docs_area: releases 
---
