...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0-alpha.20180730 since [version](cluster-settings.html#setting-version) v2.1.0-alpha.20180702
sitemap: false
docs_area: releases 
---
...
- Building CockroachDB from source now requires yarn at [version](cluster-settings.html#setting-version) 1.7.0 or above. [#27262][#27262]
...
- Added the `sql.distsql.flow_stream_timeout` and `[sql.distsql.max_running_flows](cluster-settings.html#setting-sql-distsql-max_running_flows)` [cluster settings](../v2.1/cluster-settings.html) to fine-tune flow setup [#27404][#27404]
...
- The server will not finalize a [version](cluster-settings.html#setting-version) upgrade automatically and erroneously if there are nodes temporarily inactive in the cluster. [#26821][#26821] {% comment %}doc{% endcomment %}
...
- `CHANGFEED`s now correctly emit all [version](cluster-settings.html#setting-version)s of quickly changing rows. [#27612][#27612]
...
- Updated the [rolling upgrade tutorial](../v2.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html) with explicit `systemd` commands. [#3396][#3396]
