...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-beta.20170921
sitemap: false
docs_area: releases 
---
...
- Documented how to [perform a rolling upgrade from v1.0.x to v1.1](../v1.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html). [#1899](https://github.com/cockroachdb/docs/pull/1899)
