...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.1.7 since [version](cluster-settings.html#setting-version) v19.1.6
sitemap: false
docs_area: releases 
---
...
- Prevented rare cases of infinite looping on database files written with a CockroachDB [version](cluster-settings.html#setting-version) earlier than v2.1.9. [#43253][#43253]
...
- Migrating the privileges on the `system.lease` table no longer creates a deadlock during a [cluster upgrade](../v19.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html). [#43508][#43508]
