...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.1.4 since [version](cluster-settings.html#setting-version) v19.1.3
sitemap: false
docs_area: releases 
---
...
- Ranges consisting of only one row (and historical [version](cluster-settings.html#setting-version)s of that row) are now correctly up-replicated. [#38588][#38588]
