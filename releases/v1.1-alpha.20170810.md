...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-alpha.20170810
sitemap: false
docs_area: releases 
---
...
- Improved the UX of the documentation [version](cluster-settings.html#setting-version) selector on mobile devices. [#1670](https://github.com/cockroachdb/docs/pull/1760)
- Expanded the instructions for [upgrading a cluster's [version](cluster-settings.html#setting-version)](../v1.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html). [#1769](https://github.com/cockroachdb/docs/pull/1769)
