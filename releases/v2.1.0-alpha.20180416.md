...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0-alpha.20180416 since [version](cluster-settings.html#setting-version) v2.0.0
sitemap: false
docs_area: releases 
---
...
- Relaxed the limitation on using [`BACKUP`](../v2.1/backup.html) in a mixed [version](cluster-settings.html#setting-version) cluster. [#24493][#24493]
...
- The con[version](cluster-settings.html#setting-version) from `INTERVAL` to `FLOAT` now properly returns the number of seconds in the interval. [#22892][#22892]
...
- Reduced the amount of memory used during garbage collection of old [version](cluster-settings.html#setting-version)s. [#24209][#24209]
