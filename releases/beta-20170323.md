...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20170323.
docs_area: releases 
---
...
- CockroachDB now uses `jemalloc` [version](cluster-settings.html#setting-version) 4.5.0. [#14287](https://github.com/cockroachdb/cockroach/pull/14287)
...
- CockroachDB now reports its [version](cluster-settings.html#setting-version) in two new places so that clients can distinguish CockroachDB from PostgreSQL: in the `crdb_[version](cluster-settings.html#setting-version)` variable in the network handshake, and in a new table `crdb_internal.build_info`. [#14145](https://github.com/cockroachdb/cockroach/pull/14145)
