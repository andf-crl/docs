...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20160505.
docs_area: releases 
---
...
* Scanning over records that have only one MVCC [version](cluster-settings.html#setting-version) is faster.
...
* Docs on using the [`[version](cluster-settings.html#setting-version)`](../v1.0/view-[version](cluster-settings.html#setting-version)-details.html) and [`node`](../v1.0/view-node-details.html) commands.
