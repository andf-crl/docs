...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20170105.
docs_area: releases 
---
...
- CockroachDB now uses a more recent [version](cluster-settings.html#setting-version) of GRPC. [#9697](https://github.com/cockroachdb/cockroach/pull/9697)
...
- Fixed a bug when adding columns with families to tables created by certain older beta [version](cluster-settings.html#setting-version)s of CockroachDB. [#12475](https://github.com/cockroachdb/cockroach/pull/12475)
