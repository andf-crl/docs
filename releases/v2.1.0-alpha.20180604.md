...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1-alpha.20180604 since [version](cluster-settings.html#setting-version) v2.1-alpha.20180507
sitemap: false
docs_area: releases 
---
...
- After [upgrading a cluster](../v2.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html) from v2.0 to v2.1, it is no longer necessary to manually finalize the upgrade. [#24987][#24987]
...
- The `[server.time_until_store_dead](cluster-settings.html#setting-server-time_until_store_dead)` [cluster setting](../v2.1/cluster-settings.html) can no longer be set to less than `1m15s`. Setting it to lower values was previously allowed but not safe, since it can cause bad rebalancing behavior. [#25598][#25598] {% comment %}doc{% endcomment %}
...
- Corrected the CockroachDB-specific, currently undocumented con[version](cluster-settings.html#setting-version) from [`INTERVAL`](../v2.1/interval.html) to/from numeric types. [#25257][#25257]
