...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20160915.
docs_area: releases 
---
...
- CockroachDB no longer requires Git 2.5; the minimum supported [version](cluster-settings.html#setting-version) is now 1.8. [#9325](https://github.com/cockroachdb/cockroach/pull/9325)
