...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20160908.
docs_area: releases 
---
...
- CockroachDB now builds correctly when Git worktrees are used; as a consequence Git [version](cluster-settings.html#setting-version) 2.5 or newer is now required when [building from source](../v1.0/install-cockroachdb.html). [#9072](https://github.com/cockroachdb/cockroach/pull/9072)
...
- Each [version](cluster-settings.html#setting-version)'s release notes now link to the corresponding Mac and Linux binaries. [#604](https://github.com/cockroachdb/docs/pull/604)
