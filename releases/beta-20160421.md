...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20160421.
docs_area: releases 
---
...
* This release cannot be run concurrently with older beta releases.
  ...
  node with this [version](cluster-settings.html#setting-version).
