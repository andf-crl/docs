...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.1.5 since [version](cluster-settings.html#setting-version) v19.1.4
sitemap: false
docs_area: releases 
---
...
- Prevent problems on mixed-[version](cluster-settings.html#setting-version) 19.1 clusters that are also performing a lookup join on a table that has an ongoing index backfill. [#40739][#40739]
