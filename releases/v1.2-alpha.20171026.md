...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.2-alpha.20171026
sitemap: false
docs_area: releases 
---
...
- Building the web UI now requires Node [version](cluster-settings.html#setting-version) 6 and Yarn [version](cluster-settings.html#setting-version) 0.22.0 or newer. [#18830](https://github.com/cockroachdb/cockroach/pull/18830)
- Most dependencies have been updated to their latest [version](cluster-settings.html#setting-version)s. [#17490](https://github.com/cockroachdb/cockroach/pull/17490)
...
- PostgreSQL compatibility updates: The `pg_namespace.aclitem` column has been renamed to `nspacl`. `pg_class` now  has a `relpersistence` column. New functions `pg_encoding_to_char`, `pg_get_viewdef`, and `pg_get_keywords`. The `pg_tablespace` table is now available. The type name `"char"` (with quotes) is recognized as an alias for `CHAR`. Session variable `server_[version](cluster-settings.html#setting-version)_num` is now available. [#18530](https://github.com/cockroachdb/cockroach/pull/18530) [#18618](https://github.com/cockroachdb/cockroach/pull/18618) [#19127](https://github.com/cockroachdb/cockroach/pull/19127) [#19150](https://github.com/cockroachdb/cockroach/pull/19150) [#19405](https://github.com/cockroachdb/cockroach/pull/19405)
