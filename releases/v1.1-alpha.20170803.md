...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-alpha.20170803
sitemap: false
docs_area: releases 
---
...
- CockroachDB now uses gRPC [version](cluster-settings.html#setting-version) 1.5.0. [#17166](https://github.com/cockroachdb/cockroach/pull/17166)
...
- Corrected information about how [`TIMESTAMP WITH TIME ZONE`](../v1.1/timestamp.html) works. Previous [version](cluster-settings.html#setting-version)s incorrectly said that they stored timestamps; they do not. Instead they simply display timestamps in the client's session time zone.
