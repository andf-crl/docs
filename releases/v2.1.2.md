...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.2 since [version](cluster-settings.html#setting-version) v2.1.1
sitemap: false
docs_area: releases 
---
...
- Added a secure [version](cluster-settings.html#setting-version) of the [Performance Tuning](../v2.1/performance-tuning.html) tutorial. [#4123](https://github.com/cockroachdb/docs/pull/4123)
