...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-beta.20170907
sitemap: false
docs_area: releases 
---
...
- The new [`IMPORT`](../v1.1/import.html) statement provides a fast way to import an entire table's data into CockroachDB by loading CSV files. Although this feature uses [CCL-licensed code](https://www.cockroachlabs.com/cockroachdb-community-license/), and is therefore available only in builds that include CCL-licensed code, using it is free and does not require an [enterprise.license](cluster-settings.html#setting-enterprise-license). [#17539](https://github.com/cockroachdb/cockroach/pull/17539)
...
- The distributed SQL engine avoids scheduling work on nodes running an incompatible [version](cluster-settings.html#setting-version). [#17747](https://github.com/cockroachdb/cockroach/pull/17747)
...
- The `[sql.defaults.distsql](cluster-settings.html#setting-sql-defaults-distsql).tempstorage` [cluster setting](../v1.1/cluster-settings.html) now defaults to true. [#17665](https://github.com/cockroachdb/cockroach/pull/17665)
