...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.2.3 since [version](cluster-settings.html#setting-version) v19.2.2
docs_area: releases
---
...
- Fixed a bug in the parsing logic for `[server.host_based_authentication.configuration](cluster-settings.html#setting-server-host_based_authentication-configuration)`, where both single-character strings, and quoted strings containing spaces and separated by commas, were not properly parsed. [#43714][#43714]
...
- Fixed a bug where CockroachDB could, in some cases, return an internal error when running a query with a [`CAST`](../v19.2/data-types.html#data-type-con[version](cluster-settings.html#setting-version)s-and-casts) operation (`:::`) if vectorized execution engine is used. [#43890][#43890]
