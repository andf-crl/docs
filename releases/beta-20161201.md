...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20161201.
docs_area: releases 
---
...
Due to changes in the on-disk format of internal range leases, this release cannot be run concurrently with any prior release. All servers running older [version](cluster-settings.html#setting-version)s must be stopped before starting any node with this [version](cluster-settings.html#setting-version). [#10420](https://github.com/cockroachdb/cockroach/pull/10420)
