...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.11 since [version](cluster-settings.html#setting-version) v2.1.10
sitemap: false
docs_area: releases 
---
...
- Prevented rare cases of infinite looping on database files written with a CockroachDB [version](cluster-settings.html#setting-version) earlier than v2.1.9. [#43255][#43255]
