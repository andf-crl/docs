...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1.0-rc.1
sitemap: false
docs_area: releases 
---
...
- Updated the [ActiveRecord tutorial](../v1.1/build-a-ruby-app-with-cockroachdb-activerecord.html#step-1-install-the-activerecord-orm) to clarify the dependency between the ActiveRecord [version](cluster-settings.html#setting-version) and the CockroachDB Ruby adapter. [#1949](https://github.com/cockroachdb/docs/pull/1949)
