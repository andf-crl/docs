...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.0.3
sitemap: false
docs_area: releases 
---
...
- Introduced docs for specific [version](cluster-settings.html#setting-version)s of CockroachDB. [#1605](https://github.com/cockroachdb/docs/pull/1605)
    - Documentation for the latest [production release](index.html#production-releases) is at https://www.cockroachlabs.com/docs/{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/.
    - Documentation for the latest [testing release](index.html#testing-releases) is at https://www.cockroachlabs.com/docs/{{site.[version](cluster-settings.html#setting-version)s["dev"]}}/.
    - On any page, you can switch between [version](cluster-settings.html#setting-version)s using the [version](cluster-settings.html#setting-version) selector in the lower-left.
