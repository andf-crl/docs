...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.0-beta.20180326 since [version](cluster-settings.html#setting-version) v2.0-beta.20180319
sitemap: false
docs_area: releases 
---
...
- Added the `[cloudstorage.timeout](cluster-settings.html#setting-cloudstorage-timeout)` [cluster setting](../v2.0/cluster-settings.html) for import/export operations. [#23776][#23776]

### SQL Language Changes

- SQL features introduced in CockroachDB v2.0 cannot be used in clusters that are not [upgraded fully to v2.0](../v2.0/upgrade-cockroach-[version](cluster-settings.html#setting-version).html). [#24013][#24013]
