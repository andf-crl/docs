...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v20.1.1 since [version](cluster-settings.html#setting-version) v20.1.0
docs_area: releases 
---
...
- Fixed a bug where the two settings `[kv.range_split.by_load_enabled](cluster-settings.html#setting-kv-range_split-by_load_enabled)` and `[kv.range_split.load_qps_threshold](cluster-settings.html#setting-kv-range_split-load_qps_threshold)` were incorrectly marked as non-public in the output of `SHOW CLUSTER SETTINGS`. [#48585][#48585]
...
- Re-allowed `[diagnostics.forced_sql_stat_reset.interval](cluster-settings.html#setting-diagnostics-forced_sql_stat_reset-interval)`, `diagnostics.sql_stat_reset.interval` and `[external.graphite.interval](cluster-settings.html#setting-external-graphite-interval)` to set to their maximum values (24hr, 24hr and 15min respectively). [#48760][#48760]
