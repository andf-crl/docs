...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20161215.
docs_area: releases 
---
...
- CockroachDB now uses RocksDB [version](cluster-settings.html#setting-version) 4.11.2. [#9616](https://github.com/cockroachdb/cockroach/pull/9616)
...
- The `SHOW server_[version](cluster-settings.html#setting-version)` command now returns the [version](cluster-settings.html#setting-version) of PostgreSQL that CockroachDB most closely resembles. [#12149](https://github.com/cockroachdb/cockroach/pull/12149)
