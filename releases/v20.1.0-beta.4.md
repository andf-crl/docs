...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v20.1.0-beta.4
docs_area: releases 
---
...
- [Follower reads](../v20.1/follower-reads.html) that hit intents no longer have a chance of entering an infinite loop. This bug was present in earlier [version](cluster-settings.html#setting-version)s of the v20.1 release. [#46234][#46234]
