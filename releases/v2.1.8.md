...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.8 since [version](cluster-settings.html#setting-version) v2.1.7
sitemap: false
docs_area: releases 
---
