...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.2-alpha.20171211
sitemap: false
docs_area: releases 
---
...
- Improved p99 latencies for garbage collection of previous [version](cluster-settings.html#setting-version)s of a key, when there are many [version](cluster-settings.html#setting-version)s. [#20373](https://github.com/cockroachdb/cockroach/pull/20373)
