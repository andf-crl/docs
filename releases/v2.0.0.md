...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.0.0.
sitemap: false
docs_area: releases 
---
...
- Then [upgrade to CockroachDB v2.0](../v2.0/upgrade-cockroach-[version](cluster-settings.html#setting-version).html).
...
These new features require an [[enterprise.license](cluster-settings.html#setting-enterprise-license)](../v2.0/enterprise-licensing.html). Register for a 30-day trial license [here](https://www.cockroachlabs.com/pricing/start-trial/).
