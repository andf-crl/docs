...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1.3
sitemap: false
docs_area: releases 
---
...
- [Decommissioned nodes](../v1.1/remove-nodes.html) are now excluded from the staggered [version](cluster-settings.html#setting-version) warning. [#19626](https://github.com/cockroachdb/cockroach/pull/19626)
...
- Improved Kubernetes guidance:
    ...
    - Updated the StatefulSet configurations to support rolling upgrades, and added [initial documentation](https://github.com/cockroachdb/cockroach/tree/master/cloud/kubernetes#doing-a-rolling-upgrade-to-a-different-cockroachdb-[version](cluster-settings.html#setting-version)). [#19995](https://github.com/cockroachdb/cockroach/pull/19995)
