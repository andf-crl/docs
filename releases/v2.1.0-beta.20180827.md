...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0-beta.20180827 since [version](cluster-settings.html#setting-version) v2.1.0-alpha.20180730
toc: true
sitemap: false
docs_area: releases 
---
...
- This release includes several changes to the [Change Data Capture](../v2.1/change-data-capture.html) feature:
    ...
    - `CREATE CHANGEFEED` now requires an [enterprise.license](cluster-settings.html#setting-enterprise-license) when used with Kafka. [#27962][#27962] {% comment %}doc{% endcomment %}
