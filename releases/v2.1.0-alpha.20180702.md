...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0-alpha.20180702 since [version](cluster-settings.html#setting-version) v2.1-alpha.20180604
sitemap: false
docs_area: releases 
---
...
- Metrics can now be sent to a Graphite endpoint specified using the `[external.graphite.endpoint](cluster-settings.html#setting-external-graphite-endpoint)` [cluster setting](../v2.1/cluster-settings.html). The `[external.graphite.interval](cluster-settings.html#setting-external-graphite-interval)` setting controls the interval at which this happens. [#25227][#25227]
