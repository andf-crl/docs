...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.2.0-alpha.20181217 since [version](cluster-settings.html#setting-version) v2.2.0-alpha.20181119
sitemap: false
docs_area: releases 
---
...
- `ncurses` is now linked statically so that the cockroach binary no longer requires a particular [version](cluster-settings.html#setting-version) of the `ncurses` shared library to be available on deployment machines. [#32959][#32959]
