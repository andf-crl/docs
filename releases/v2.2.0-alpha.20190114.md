...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.2.0-alpha.20190114 since [version](cluster-settings.html#setting-version) v2.2.0-alpha.20181217
sitemap: false
docs_area: releases
---
...
- Added support for the `pg_catalog` introspection table `pg_am` for both PostgreSQL [version](cluster-settings.html#setting-version)s 9.5 and 9.6, which changed the table significantly. [#33252][#33252]
