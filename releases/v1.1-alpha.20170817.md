...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-alpha.20170817
sitemap: false
docs_area: releases 
---
...
- Query processing can now take advantage of on-disk storage, rather than erroring out when the working set of the query is too large to fit in memory. This is turned off by default in this release, but can be enabled by setting the `[sql.defaults.distsql](cluster-settings.html#setting-sql-defaults-distsql).tempstorage` [cluster setting](../v1.1/cluster-settings.html) to true.
...
- Updated the flag and response field definitions for the [`cockroach [version](cluster-settings.html#setting-version)`](../v1.1/view-[version](cluster-settings.html#setting-version)-details.html) command.
