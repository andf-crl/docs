...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1.7 since [version](cluster-settings.html#setting-version) v1.1.6
sitemap: false
docs_area: releases 
---
