...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-alpha.20170720
sitemap: false
docs_area: releases 
---
...
- Added docs on the [cluster and [version](cluster-settings.html#setting-version) details](../v1.1/use-the-built-in-sql-client.html#sql-shell-welcome-changed-in-v1-1) that are printed upon connecting the built-in SQL shell to a node. [#1714](https://github.com/cockroachdb/docs/pull/1714)
