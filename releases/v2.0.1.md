...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.0.1 since [version](cluster-settings.html#setting-version) v2.0.0
sitemap: false
docs_area: releases 
---
...
- The new `[server.clock.persist_upper_bound_interval](cluster-settings.html#setting-server-clock-persist_upper_bound_interval)` [cluster setting](../v2.0/cluster-settings.html) can be used to guarantees monotonic wall time across server restarts. [#24624][#24624]
- The new `[server.clock.forward_jump_check_enabled](cluster-settings.html#setting-server-clock-forward_jump_check_enabled)` [cluster setting](../v2.0/cluster-settings.html) can be used to cause nodes to panic on clock jumps. [#24606][#24606]
...
- Relaxed the limitation on using [`BACKUP`](../v2.0/backup.html) in a mixed [version](cluster-settings.html#setting-version) cluster. [#24515][#24515]
