...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0.
sitemap: false
docs_area: releases
---
...
- Then [upgrade to CockroachDB v2.1](../v2.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html).
...
These new features require an [[enterprise.license](cluster-settings.html#setting-enterprise-license)](../v2.1/enterprise-licensing.html). Register for a 30-day trial license [here](https://www.cockroachlabs.com/get-cockroachdb/enterprise).
...
These new features are freely available in the core [version](cluster-settings.html#setting-version) and do not require an [enterprise.license](cluster-settings.html#setting-enterprise-license).

#### SQL

Feature | Description
--------|------------
[`ALTER TABLE ... ALTER TYPE`](../v2.1/alter-type.html) | The `ALTER TABLE ... ALTER TYPE` statement changes a column's [data type](../v2.1/data-types.html). Only type changes that neither require data checks nor data con[version](cluster-settings.html#setting-version) are supported at this time.
...
[Cost-Based Optimizer](../v2.1/cost-based-optimizer.html) | The cost-based optimizer seeks the lowest cost for a query, usually related to time. In [version](cluster-settings.html#setting-version)s 2.1 and later, CockroachDB's cost-based optimizer is enabled by default.
...
[Rolling Upgrade Auto-finalization](../v2.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html) | By default, as soon as all nodes are running CockroachDB v2.1, the upgrade process will be **auto-finalized**. This will enable certain performance improvements and bug fixes introduced in the new [version](cluster-settings.html#setting-version).
