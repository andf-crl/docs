...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0-rc.2 since [version](cluster-settings.html#setting-version) v2.1.0-rc.1
sitemap: false
docs_area: releases 
---
