...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20170112.
docs_area: releases 
---
...
- This release cannot be run concurrently with older beta releases. Please stop all nodes running older releases before restarting any node with this [version](cluster-settings.html#setting-version).
...
- Added documentation on [SQL type con[version](cluster-settings.html#setting-version)s](../v1.0/data-types.html#data-type-con[version](cluster-settings.html#setting-version)s-casts). [#977](https://github.com/cockroachdb/docs/pull/977)
