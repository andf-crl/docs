...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0-beta.20180904 since [version](cluster-settings.html#setting-version) v2.1.0-beta.20180827
sitemap: false
docs_area: releases 
---
...
- The [`cockroach dump`](../v2.1/sql-dump.html) command can once again operate across multiple CockroachDB [version](cluster-settings.html#setting-version)s. [#29006][#29006]
...
- Improve the handling of jobs run prior to a [cluster upgrade](../v2.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html). [#29019][#29019]
