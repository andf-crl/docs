...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-beta.20170928
sitemap: false
docs_area: releases 
---
...
- The [cluster settings](../v1.1/cluster-settings.html) beginning with `[sql.defaults.distsql](cluster-settings.html#setting-sql-defaults-distsql).tempstorage` have been renamed to begin with `sql.distsql.temp_storage`. [#18487](https://github.com/cockroachdb/cockroach/pull/18487)
- The new `[sql.distsql.temp_storage.workmem](cluster-settings.html#setting-sql-distsql-temp_storage-workmem)` [cluster setting](../v1.1/cluster-settings.html) sets the memory threshold at which a DistSQL processor falls back to on-disk storage. Defaults to 64MiB. [#18487](https://github.com/cockroachdb/cockroach/pull/18487)
...
- The distributed SQL engine now avoids scheduling work on nodes running [version](cluster-settings.html#setting-version) 1.0.x in a mixed-[version](cluster-settings.html#setting-version) cluster. [#18546](https://github.com/cockroachdb/cockroach/pull/18546)
...
- Fixed the display of [version](cluster-settings.html#setting-version) numbers. [#18562](https://github.com/cockroachdb/cockroach/pull/18562)
