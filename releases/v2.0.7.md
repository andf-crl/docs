...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.0.7 since [version](cluster-settings.html#setting-version) v2.0.6
sitemap: false
docs_area: releases 
---
