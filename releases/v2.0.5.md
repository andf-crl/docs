...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.0.5 since [version](cluster-settings.html#setting-version) v2.0.4
sitemap: false
docs_area: releases 
---
