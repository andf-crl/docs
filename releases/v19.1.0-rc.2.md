...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.1.0-rc.2 since [version](cluster-settings.html#setting-version) v19.1.0-rc.1
sitemap: false
docs_area: releases 
---
...
- Added the `[sql.defaults.reorder_joins_limit](cluster-settings.html#setting-sql-defaults-reorder_joins_limit)` [cluster setting](../v19.1/cluster-settings.html), which defines the default value of the `reorder_joins_limit` [session variable](../v19.1/set-vars.html). [#36382][#36382]
