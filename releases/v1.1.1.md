...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1.1
sitemap: false
docs_area: releases 
---
...
- `SET CLUSTER SETTING [version](cluster-settings.html#setting-version) = '1.1'` now works correctly. You issue this command when [finalizing a cluster upgrade from 1.0.x to 1.1.1](../v1.1/upgrade-cockroach-[version](cluster-settings.html#setting-version).html). [#19225](https://github.com/cockroachdb/cockroach/pull/19225)
