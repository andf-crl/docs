...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.2.6 since [version](cluster-settings.html#setting-version) v19.2.5
docs_area: releases 
---
...
- The display options are now saved separately for each authenticated user. **Note:** When upgrading to a [version](cluster-settings.html#setting-version) with this change, all current display customizations for admin users are lost. [#46479][#46479]
