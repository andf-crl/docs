...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.1.0-rc.3 since [version](cluster-settings.html#setting-version) v19.1.0-rc.2
sitemap: false
docs_area: releases 
---
...
- Fixed a potential crash in a mixed-[version](cluster-settings.html#setting-version) cluster with some nodes running `v19.1-beta-x` and others running `19.1-rc.x`. [#36719][#36719]
