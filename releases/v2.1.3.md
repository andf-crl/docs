...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.3 since [version](cluster-settings.html#setting-version) v2.1.2
sitemap: false
docs_area: releases 
---
...
- `ncurses` is now linked statically so that the `cockroach` binary no longer requires a particular [version](cluster-settings.html#setting-version) of the `ncurses` shared library to be available on deployment machines. [#32960][#32960] {% comment %}doc{% endcomment %}
