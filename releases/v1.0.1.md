...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.0.1
sitemap: false
docs_area: releases 
---
...
- A clear error message is now printed when running on Windows [version](cluster-settings.html#setting-version)s older than 8 (the oldest [version](cluster-settings.html#setting-version) we support). [#15920](https://github.com/cockroachdb/cockroach/pull/15920)
