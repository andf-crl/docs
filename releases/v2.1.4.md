...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.4 since [version](cluster-settings.html#setting-version) v2.1.3
sitemap: false
docs_area: releases 
---
...
- Added support for the `pg_catalog` introspection table `pg_am` for both PostgreSQL [version](cluster-settings.html#setting-version)s 9.5 and 9.6, which changed the table significantly. [#33276][#33276]
