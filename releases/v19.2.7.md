...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.2.7 since [version](cluster-settings.html#setting-version) v19.2.6
docs_area: releases 
---
...
- Prior to this patch, the phase of server shutdown responsible for range lease transfers to other nodes had a hard timeout of 5 seconds. This timeout is now configurable with the new [cluster setting](../v19.2/set-cluster-setting.html) `[server.shutdown.lease_transfer_wait](cluster-settings.html#setting-server-shutdown-lease_transfer_wait)`. [#47691][#47691]
