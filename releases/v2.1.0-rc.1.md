...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.1.0-rc.1 since [version](cluster-settings.html#setting-version) v2.1.0-beta.20181015
sitemap: false
docs_area: releases 
---
