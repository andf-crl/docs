...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v1.1-alpha.20170713
sitemap: false
docs_area: releases 
---
...
- The new `[trace.zipkin.collector](cluster-settings.html#setting-trace-zipkin-collector)` [cluster setting](../v1.1/cluster-settings.html) can now be used to report trace data to Zipkin. [#16903](https://github.com/cockroachdb/cockroach/pull/16903)
...
- The [SQL shell](../v1.1/use-the-built-in-sql-client.html) prints the client and server [version](cluster-settings.html#setting-version) number at startup. [#16703](https://github.com/cockroachdb/cockroach/pull/16703)
