...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20160407.
docs_area: releases 
---
...
* Added SQL `[version](cluster-settings.html#setting-version)()` [function](../v1.0/functions-and-operators.html).
  [#5763](https://github.com/cockroachdb/cockroach/pull/5763)
* Added compiler and platform information to `cockroach [version](cluster-settings.html#setting-version)`
