...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v20.1.2 since [version](cluster-settings.html#setting-version) v20.1.1
docs_area: releases 
---
...
- Updated the [Active Record tutorial](../v20.1/build-a-ruby-app-with-cockroachdb-activerecord.html) to use a new CockroachDB adapter [version](cluster-settings.html#setting-version). [#7480][#7480]
