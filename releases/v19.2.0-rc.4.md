...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.2.0-rc.4 since [version](cluster-settings.html#setting-version) v19.2.0-rc.3
docs_area: releases 
---
...
- Added the `[sql.defaults.zigzag_join.enabled](cluster-settings.html#setting-sql-defaults-zigzag_join-enabled)` [cluster setting](../v19.2/cluster-settings.html), which can be used to control the default value of the `enable_zigzag_join` [session variable](../v19.2/set-vars.html) and, thus, whether zig-zag joins are allowed. [#42182][#42182]
