...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.2.0-beta.20190930 since [version](cluster-settings.html#setting-version) v19.2.0-alpha.20190805
docs_area: releases 
---
...
- Using [`cockroach start`](../v19.2/cockroach-start.html) without `--join` is now deprecated and this mode of execution will be removed in a later [version](cluster-settings.html#setting-version) of CockroachDB. Consider using `cockroach start-single-node` instead or combine `cockroach start` with [`cockroach init`](../v19.2/cockroach-init.html). [#28495][#28495] {% comment %}doc{% endcomment %}
