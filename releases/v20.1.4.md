...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v20.1.4 since [version](cluster-settings.html#setting-version) v20.1.3
docs_area: releases 
---
...
- Fixed a bug causing traces collected through the `[sql.trace.txn.enable_threshold](cluster-settings.html#setting-sql-trace-txn-enable_threshold)` setting to be incomplete sometimes. [#51845][#51845]
