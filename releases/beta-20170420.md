...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) beta-20170420.
docs_area: releases 
---
...
- This release cannot run at the same time as releases prior to [`beta-20170413`](beta-20170413.html). If you are running an older [version](cluster-settings.html#setting-version), you must either upgrade to that [version](cluster-settings.html#setting-version) first or take down all servers in the cluster before starting any server with this [version](cluster-settings.html#setting-version). This release includes new functionality to make future upgrades smoother. [#14959](https://github.com/cockroachdb/cockroach/pull/14959)
