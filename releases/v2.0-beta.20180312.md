...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v2.0-beta.20180312 since [version](cluster-settings.html#setting-version) v2.0-beta.20180305
sitemap: false
docs_area: releases 
---
...
- Disabling [diagnostics reporting](../v1.1/diagnostics-reporting.html) also disables new [version](cluster-settings.html#setting-version) notification checks. [#23007][#23007]
...
- In the geographical map on the homepage of the Admin UI enterprise [version](cluster-settings.html#setting-version), node components now link to **Note Details** page. [#23283][#23283]
...
- A node now waits in an unready state for the length of time specified by the `[server.shutdown.drain_wait](cluster-settings.html#setting-server-shutdown-drain_wait)` cluster setting before draining. This helps ensure that load balancers will not send client traffic to a node about to be drained. [#23319][#23319]
...
- Hardened the [cluster [version](cluster-settings.html#setting-version) upgrade](../v2.0/upgrade-cockroach-[version](cluster-settings.html#setting-version).html) mechanism. Rapid upgrades through more than two [version](cluster-settings.html#setting-version)s could sometimes fail recoverably. [#23287][#23287]
