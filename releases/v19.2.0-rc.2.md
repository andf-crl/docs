...
toc: true
summary: Additions and changes in CockroachDB [version](cluster-settings.html#setting-version) v19.2.0-rc.2 since [version](cluster-settings.html#setting-version) v19.2.0-rc.1
docs_area: releases 
---
...
- [`IMPORT`](../v19.2/import.html) is no longer allowed during a [rolling upgrade](../v19.2/upgrade-cockroach-[version](cluster-settings.html#setting-version).html). [#41733][#41733] {% comment %}doc{% endcomment %}
...
- Clarified that to upgrade to the next major [version](cluster-settings.html#setting-version) [upgrade path for rolling upgrades](../v19.2/upgrade-cockroach-[version](cluster-settings.html#setting-version).html), a cluster must be on a production release of the previous [version](cluster-settings.html#setting-version), as opposed to a testing release (alpha/beta). [#5644][#5644]
...
- Updated [Helm-specific instructions](../v19.2/orchestrate-cockroachdb-with-kubernetes.html) for Kubernetes [version](cluster-settings.html#setting-version) 1.16.0 and fixed various errors. [#5657][#5657], [#5659][#5659]
