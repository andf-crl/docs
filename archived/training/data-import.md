...
1. Download our sample [`pg_dump.sql`](resources/pg_dump.sql) file using [`curl`][curl] or [`wget`][wget], depending on which you have installed:
    ...
    {% include copy-clipboard.html %}
    ~~~ shell
    $ curl -O {{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/pg_dump.sql
    ~~~

    {% include copy-clipboard.html %}
    ~~~ shell
    $ wget {{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/pg_dump.sql
    ~~~
...
3. Instead of manually cleaning the file, you can download our pre-cleaned [version](cluster-settings.html#setting-version) using [`curl`][curl] or [`wget`][wget]:

    {% include copy-clipboard.html %}
    ~~~ shell
    $ curl -O {{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/pg_dump_cleaned.sql
    ~~~

    {% include copy-clipboard.html %}
    ~~~ shell
    $ wget {{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/pg_dump_cleaned.sql
    ~~~
...
5. Import the dump:
    ...
    --host=localhost:26257 \
    --database=pg_import \
    --execute="IMPORT PGDUMP '{{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/pg_dump_cleaned.sql';"
    ~~~
...
1. Download our sample [`mysql_dump.sql`](resources/mysql_dump.sql) file using [`curl`][curl] or [`wget`][wget]:
    ...
    {% include copy-clipboard.html %}
    ~~~ shell
    $ curl -O {{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/mysql_dump.sql
    ~~~

    {% include copy-clipboard.html %}
    ~~~ shell
    $ wget {{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/mysql_dump.sql
    ~~~
...
4. Import the dump:
    ...
    --insecure \
    --host=localhost:26257 \
    --execute="IMPORT MYSQLDUMP '{{site.url}}/docs/{{page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)}}/training/resources/mysql_dump.sql';"
    ~~~
