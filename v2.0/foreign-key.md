...
### Foreign Key Actions <span class="[version](cluster-settings.html#setting-version)-tag">New in v2.0</span>
...
### Use a Foreign Key Constraint with `CASCADE` <span class="[version](cluster-settings.html#setting-version)-tag">New in v2.0</span>
...
### Use a Foreign Key Constraint with `SET NULL` <span class="[version](cluster-settings.html#setting-version)-tag">New in v2.0</span>
...
### Use a Foreign Key Constraint with `SET DEFAULT` <span class="[version](cluster-settings.html#setting-version)-tag">New in v2.0</span>
