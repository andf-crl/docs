...
{% include_cached new-in.html [version](cluster-settings.html#setting-version)="v21.2" %} To view the most recent backup, use the `LATEST` syntax:
...
{% include_cached new-in.html [version](cluster-settings.html#setting-version)="v21.2" %} Use `WITH debug_ids` to display the descriptor IDs related to each object in the backup:
