...
1. Open another terminal (call it _terminal 3_), and use [`cockroach sql`](cockroach-sql.html) to connect to a node in a different region in the demo cluster:
    ...
    # To exit, type: \q.
    #
    # Server [version](cluster-settings.html#setting-version): CockroachDB CCL v21.2.0-rc.2 (x86_64-apple-darwin19, built 2021/10/25 20:36:07, go1.16.6) (same [version](cluster-settings.html#setting-version) as client)
