...
<span class="[version](cluster-settings.html#setting-version)-tag">New in v20.2:</span> The `PAUSE SCHEDULES` [statement](sql-statements.html) can be used to pause [backup schedules](create-schedule-for-backup.html).
