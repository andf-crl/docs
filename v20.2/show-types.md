...
<span class="[version](cluster-settings.html#setting-version)-tag">New in v20.2:</span> The `SHOW TYPES` statement lists the user-defined [data types](data-types.html) in the current database.
