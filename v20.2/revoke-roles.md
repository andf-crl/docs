...
{{site.data.alerts.callout_info}}
 <code>REVOKE &lt;roles&gt;</code> is no longer an Enterprise feature and is now freely available in the core [version](cluster-settings.html#setting-version) of CockroachDB.
