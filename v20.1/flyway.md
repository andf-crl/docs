...
1. Download the latest [version](cluster-settings.html#setting-version) of the [Flyway command-line tool](https://flywaydb.org/documentation/commandline/#download-and-installation). CockroachDB v20.1 is fully compatible with Flyway [version](cluster-settings.html#setting-version)s 6.4.2 and greater.
