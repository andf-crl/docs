...
For more details about encryption in {{ site.data.products.db }}, see [Encryption At Rest](/docs/{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/encryption.html).
