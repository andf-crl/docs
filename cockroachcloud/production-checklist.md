...
To ensure optimal SQL performance for your {{ site.data.products.db }} cluster, follow the best practices described in the [SQL Performance Best Practices](../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/performance-best-practices-overview.html) guide.
...
For guidance on sizing, validating, and using connection pools with CockroachDB, see [Use Connection Pools](../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/connection-pooling.html).
