...
Use the [`EXPERIMENTAL_AUDIT`](../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/experimental-audit.html) subcommand of [`ALTER TABLE`](../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/alter-table.html):
