...
- The right [survival goal](../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/multiregion-overview.html#survival-goals) for each database.
- The right [table locality](../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/multiregion-overview.html#table-locality) for each of your tables.
