...
<div class="container">
  ...
  <div class="row display-flex pb-4">
    ...
    <div class="col-6 col-lg-3">
      ...
      <div class="landing-column-content">
      <ul>
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/migration-overview.html">Migrate Data</a></li>
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/performance-best-practices-overview.html">Tune Performance</a></li>
    ...
    <div class="col-6 col-lg-3">
      ...
      <div class="landing-column-content">
      <ul>
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/developer-guide-overview.html">Common Dev Tasks</a></li>
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/example-apps.html">Sample Apps</a></li>
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/sql-feature-support.html">SQL Reference</a></li>
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/performance-best-practices-overview.html">SQL Best Practices</a></li>
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/error-handling-and-troubleshooting.html">SQL Troubleshooting</a></li>
        </ul>
      </div>
    </div>
    <div class="col-6 col-lg-3">
      ...
      <ul>
        ...
        <li><a href="../{{site.[version](cluster-settings.html#setting-version)s["stable"]}}/frequently-asked-questions.html">CockroachDB FAQs</a></li>
