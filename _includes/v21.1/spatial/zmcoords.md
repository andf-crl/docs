{% include_cached new-in.html [version](cluster-settings.html#setting-version)="v21.1" %} You can also store a `{{page.title}}` with the following additional dimensions:
