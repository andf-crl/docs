...
- Fixed a rare bug which could cause a crash if [`CREATE SCHEMA`](../v20.2/create-schema.html) were run in a transaction which began prior to a cluster [version](cluster-settings.html#setting-version) update which enabled that statement. [#63786][#63786]
