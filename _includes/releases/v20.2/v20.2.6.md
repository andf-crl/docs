...
- The [`cockroach` command](../v20.2/cockroach-commands.html) now supports the command-line parameter `--[version](cluster-settings.html#setting-version)` which reports its [version](cluster-settings.html#setting-version) parameters. This makes `cockroach --[version](cluster-settings.html#setting-version)` equivalent to [`cockroach [version](cluster-settings.html#setting-version)`](../v20.2/cockroach-[version](cluster-settings.html#setting-version).html). [#59753][#59753] {% comment %}doc{% endcomment %}
- The [`cockroach [version](cluster-settings.html#setting-version)`](../v20.2/cockroach-[version](cluster-settings.html#setting-version).html) command now supports a new parameter `--build-tag`. When `--build-tag` is specified, `cockroach [version](cluster-settings.html#setting-version)` displays the technical build tag, which makes it possible to integrate with automated deployment tools. [#59753][#59753] {% comment %}doc{% endcomment %}
