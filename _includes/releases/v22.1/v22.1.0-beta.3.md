...
- `LATEST` files are no longer overwritten and are now [version](cluster-settings.html#setting-version)ed and written in the `/metadata/latest` directory for non-mixed-[version](cluster-settings.html#setting-version) clusters. [#79553][#79553]
