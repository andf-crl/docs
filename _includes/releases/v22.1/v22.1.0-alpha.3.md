...
- A new [built-in scalar function](../v22.1/functions-and-operators.html) `crdb_internal.active_[version](cluster-settings.html#setting-version)()` can now be used alongside `crdb_internal.is_at_least_[version](cluster-settings.html#setting-version)()` to determine which cluster [version](cluster-settings.html#setting-version) is currently active and choose client-side feature levels accordingly. [#77233][#77233]
