...
- The query logging enabled by `[sql.telemetry.query_sampling.enabled](cluster-settings.html#setting-sql-telemetry-query_sampling-enabled)` now avoids considering SQL statements issued internally by CockroachDB itself. [#70358][#70358]
