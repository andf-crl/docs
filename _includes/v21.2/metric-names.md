...
`[sql.guardrails.max_row_size_err](cluster-settings.html#setting-sql-guardrails-max_row_size_err).count` | Number of times a large row violates the corresponding `[sql.guardrails.max_row_size_err](cluster-settings.html#setting-sql-guardrails-max_row_size_err)` limit.
`[sql.guardrails.max_row_size_log](cluster-settings.html#setting-sql-guardrails-max_row_size_log).count` | Number of times a large row violates the corresponding `[sql.guardrails.max_row_size_log](cluster-settings.html#setting-sql-guardrails-max_row_size_log)` limit.
