...
{{page.release_info.docker_image}}:{{page.release_info.[version](cluster-settings.html#setting-version)}} start --insecure
~~~
...
{{page.release_info.docker_image}}:{{page.release_info.[version](cluster-settings.html#setting-version)}} start --insecure --join=roach1
~~~
