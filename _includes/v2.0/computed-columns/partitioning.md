{{site.data.alerts.callout_info}}Partioning is an enterprise feature. To request and enable a trial or full [enterprise.license](cluster-settings.html#setting-enterprise-license), see <a href="enterprise-licensing.html">Enterprise Licensing</a>.{{site.data.alerts.end}}
