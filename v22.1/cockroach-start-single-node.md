...
build:               CCL {{page.release_info.[version](cluster-settings.html#setting-version)}} @ {{ site.data.releases | where_exp: "release", "release.major_[version](cluster-settings.html#setting-version) == page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)" | where: "withdrawn", "false" | sort: "release_date" | last | map: "release_date" | date: "%Y/%m/%d 12:34:56" }} {{ site.data.releases | where_exp: "release", "release.major_[version](cluster-settings.html#setting-version) == page.[version](cluster-settings.html#setting-version).[version](cluster-settings.html#setting-version)" | where: "withdrawn", "false" | sort: "release_date" | last | map: "go_[version](cluster-settings.html#setting-version)" }}
