...
{% include_cached new-in.html [version](cluster-settings.html#setting-version)="v22.1" %} [Hash-sharded indexes](hash-sharded-indexes.html) can be used for uniqueness checks.
